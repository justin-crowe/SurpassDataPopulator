...
namespace SurpassDataPopulator.Console.Cli.Verbs.Create.Adaptive
{
    ...
    public class CreateAdaptiveItems : CreateItems
    {
        [Option('v', "variants", Required = false,
            HelpText = "List of language codes required for variants, this will create copies of items for each variants and link them. Then also add the relevant Adaptive tagging")]
