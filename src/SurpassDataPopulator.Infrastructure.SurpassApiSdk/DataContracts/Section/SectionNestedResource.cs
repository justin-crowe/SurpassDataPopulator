...
public class SectionNestedResource : SectionBaseResource, ISectionExtendedResource
{
    ...
    [DataMember(Name = ApiConsts.Members.Sections, EmitDefaultValue = false, Order = 9)]
    public List<SectionExtendedResource> Sections { get; set; }
