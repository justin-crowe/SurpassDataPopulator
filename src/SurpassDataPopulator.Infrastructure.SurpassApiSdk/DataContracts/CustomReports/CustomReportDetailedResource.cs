...
namespace SurpassApiSdk.DataContracts.CustomReports
{
    ...
    public class CustomReportDetailedResource
    {
        ...
        [DataMember(Name = ApiConsts.Members.CustomReportTemplatingEngine, Order = 4, EmitDefaultValue = false)]
        [JsonConverter(typeof(JsonStringEnumConverter))]
        public CustomReportTemplatingEngineType TemplatingEngine { get; set; }

        [DataMember(Name = ApiConsts.Members.CustomReportCreationDate, Order = 5, EmitDefaultValue = false)]
        public DateTime CreationDate { get; set; }

        [DataMember(Name = ApiConsts.Members.CustomReportTemplate, Order = 6, EmitDefaultValue = false)]
        public CustomReportTemplateFileResource TemplateFile { get; set; }
    }
}
